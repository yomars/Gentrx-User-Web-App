  ...
  return (
    <Box>
      ...
      <Box position="relative" overflow="hidden" bg="#f0faf7">
        <Image
          src={resolveMediaUrl(settingsData?.find((v) => v.id_name === "web_about_hero_image")?.value) || "/images/about-us/main-hero.png"}
          alt="Doctor at work"
          w="80%"
      ...
      <Box bg="white" py={{ base: 12, md: 16 }} px={{ base: 5, md: 8, lg: 12 }}>
        <Box maxW="1180px" mx="auto" position="relative">
            ...
            <Box maxW={{ base: "100%", lg: "46%" }}>
              ...
              <Flex gap={4} mt={5} wrap="wrap">
                <a href={playStoreHref} target="_blank" rel="noopener noreferrer">
                  <Image src={resolveMediaUrl(settingsData?.find((v) => v.id_name === "web_badge_play_store")?.value) || "/play store.png"} fallbackSrc="/google-play-icon.svg" w={{ base: 140, md: 180 }} />
                </a>
                <a href={appStoreHref} target="_blank" rel="noopener noreferrer">
                  <Image src={resolveMediaUrl(settingsData?.find((v) => v.id_name === "web_badge_app_store")?.value) || "/app store.png"} fallbackSrc="/apple-store-icon.svg" w={{ base: 140, md: 180 }} />
                </a>
              </Flex>
            </Box>
          ...
          >
              <Image
                src={resolveMediaUrl(settingsData?.find((v) => v.id_name === "web_about_mobile_image")?.value) || "/images/about-us/mobile-app.png"}
