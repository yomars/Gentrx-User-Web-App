...
const formattedData = (data) => {
  ...
  return {
    ...
    doctor_fee: parseFloat(data.doctor_fee || 0).toFixed(1),
    clinic_fee: parseFloat(data.clinic_fee || 0).toFixed(1),
    pipe_fee: parseFloat(data.pipe_fee || 0).toFixed(1),
    doctor_wallet_owner_id: data.doctor_wallet_owner_id || "",
    clinic_wallet_owner_id: data.clinic_wallet_owner_id || "",
    pipe_wallet_owner_id: data.pipe_wallet_owner_id || "",
    status: data.status,
    date: data.date,
