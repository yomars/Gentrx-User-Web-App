...
echo "==> Starting user web app on port 4000"
pm2 delete gentrx-user-web >/dev/null 2>&1 || true
pm2 start scripts/deploy/ecosystem.user-web.cjs
pm2 save
...
echo "==> Done"
echo "Local app check: curl -I http://127.0.0.1:4000/"
