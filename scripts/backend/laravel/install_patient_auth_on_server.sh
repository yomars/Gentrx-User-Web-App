...
require_file "$REPO_ROOT/scripts/backend/laravel/config/services.php"
...
cp "$REPO_ROOT/scripts/backend/laravel/config/services.php" "$LARAVEL_ROOT/config/services.php"
